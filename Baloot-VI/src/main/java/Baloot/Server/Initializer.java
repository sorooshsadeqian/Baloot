...
public class Initializer {
    ...
    void initCommodities() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
    ...
    void initComments() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
    ...
    void initDiscountCodes() throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(Consts.BALOOT_DISCOUNT_CODES_URL))
                .GET()
                .build();
        ...
        List<AddDiscountCodeRequest> discountCodes = new Gson().fromJson(response.body(), new TypeToken<List<AddDiscountCodeRequest>>(){}.getType());
        for (AddDiscountCodeRequest discountCode: discountCodes) {
            api.addDiscountCode(discountCode);
        }
    }
